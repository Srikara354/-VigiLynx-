...
import CommunityPost from './components/CommunityPosts'; // New Component
import ThreatDashboard from './components/ThreatDashboard'; // New Component
      ...
      >
        <div className="container mx-auto max-w-6xl flex justify-between items-center">
          ...
          <nav className="flex space-x-4">
            <button onClick={() => setView('cyberguard')} className={`btn ${view === 'cyberguard' ? 'btn-primary' : 'btn-secondary'}`}>
              CyberGuard
            </button>
            <button onClick={() => setView('parental')} className={`btn ${view === 'parental' ? 'btn-primary' : 'btn-secondary'}`}>
              Parental Monitor
            </button>
            <button onClick={() => setView('news')} className={`btn ${view === 'news' ? 'btn-primary' : 'btn-secondary'}`}>
              Cybersecurity News
            </button>
            <button onClick={() => setView('community')} className={`btn ${view === 'community' ? 'btn-primary' : 'btn-secondary'}`}>
              Community Post
            </button>
            <button onClick={() => setView('threat')} className={`btn ${view === 'threat' ? 'btn-primary' : 'btn-secondary'}`}>
              Threat Dashboard
            </button>
          </nav>
        </div>
